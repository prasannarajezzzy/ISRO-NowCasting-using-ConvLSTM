...
Original file is located at
    https://colab.research.google.com/drive/1i-ood4mDFZHfk0IHErGqNDgn0HOVcYCH
"""
...
import xarray as xr 
xf=xr.open_dataset("/content/drive/My Drive/files_3dr.nc")
...
ans= predict( data[51:52], Encoder_model, Forecaster_model, 12)
...
Encoder_model.save("Encoder_3DR_VIS.h5")
Decoder_model.save("Decoder_3DR_VIS.h5")
Forecaster_model.save("Forecaster_3DR_VIS.h5")

for i in range(12):
  plt.imshow(ans1[0,i,:,:,0],cmap="gray")
  plt.colorbar()
  plt.show()
